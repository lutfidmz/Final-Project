...
// hover ava
        ...
        $(document).ready(function(){
            $("#avaLutfi").hover(function() {
                 $(this).attr("src","assets/img/lutfidmz.svg");
                 $('#hoverUs').hide();

            }, function(){
                 $(this).attr("src","assets/img/lutfidmzDef.svg");

            });

            $("#avaDorin").hover(function() {
                 $(this).attr("src","assets/img/dorin.svg");
                 $('#hoverUs').hide();

            }, function(){
                 $(this).attr("src","assets/img/dorinDef.svg");
            });

            $("#avaKimbra").hover(function() {
                 $(this).attr("src","assets/img/kimbra.svg");
                 $('#hoverUs').hide();
            }, function(){
                 $(this).attr("src","assets/img/kimbraDef.svg");
            });
...
var typed = new Typed('#typed',{
        strings:["Hai !","Selamat datang di magr.tech","Masih Mengerjakan Semua Pekerjaan Sendirian?","Kapan terakhir kali kamu berlibur?", "Seperti berlibur" ,"tidur","memanjakan dirimu","pergi berolahraga", "tanpa perlu memikirkan rutinitas yang menjemukan", "lalu dunia bekerja untukmu"],
        backSpeed: 4,
        backDelay : 1500,
        typeSpeed: 30,
        loop: true,
